...
// ============================================================================
// 文件: GaussianSplatRendererEditor.cs
// 功能: 高斯溅射渲染器编辑器（Inspector 与编辑工具）
// 说明:
//   为GaussianSplatRenderer组件提供Inspector界面
//   功能包括:
//   1. 显示渲染参数(缩放、不透明度、球谐阶数等)
//   2. 相机管理 - 激活不同的点云扫描相机
//   3. 编辑工具 - 支持多物体合并
//   4. 裁剪体管理 - 创建/删除裁剪区域
//   5. 数据导出 - 将编辑后的数据导出为PLY格式
//   6. 编辑统计 - 显示选中/删除/裁剪的溅射数
// ============================================================================
