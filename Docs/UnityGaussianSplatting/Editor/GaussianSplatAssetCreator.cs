...
// ============================================================================
// 文件: GaussianSplatAssetCreator.cs
// 功能: 高斯溅射资产创建窗口 - 将PLY/SPZ文件转换为Unity高斯溅射资产
// 说明:
//   这是编辑器窗口，用于加载点云数据(PLY或SPZ格式)并创建Unity资产
//   功能包括:
//   1. 读取PLY/SPZ文件(点云数据格式)
//   2. Morton编码重新排序数据以提高缓存效率
//   3. 可选的球谐函数K-Means聚类来压缩SH数据
//   4. 多种压缩质量预设
//   5. 将处理后的数据导出为Unity TextAsset
//   6. 支持导入相机位置信息
// ============================================================================
...
namespace GaussianSplatting.Editor
{
    /// <summary>
    /// 高斯溅射资产创建窗口
    /// 负责将原始点云数据（PLY/SPZ）处理并转换为 Unity 渲染所需格式
    /// </summary>
    [BurstCompile]
    public class GaussianSplatAssetCreator : EditorWindow
    {
        ...
        // 打开“Create Gaussian Splat Asset”编辑器窗口。
