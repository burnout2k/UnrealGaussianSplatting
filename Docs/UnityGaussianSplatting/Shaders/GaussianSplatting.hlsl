...
// ============================================================================
// 文件: GaussianSplatting.hlsl
// 功能: 高斯溅射核心数学（GPU 侧 3DGS 关键算法）
// 说明:
//   这是所有高斯溅射渲染的核心数学库，包含:
//   1. 几何变换: 四元数、旋转、协方差矩阵计算
//   2. 投影: 3D高斯椭球体投影到2D屏幕空间
//   3. 球谐函数: 视角相关颜色编码/解码
//   4. 空间数据结构: Morton编码用于缓存优化
//   5. 数据编码: 支持多种数据格式解码
//   
//   关键概念:
//   - 3D高斯椭球：由中心位置、旋转四元数、缩放向量描述
//   - 2D协方差：3D协方差投影到屏幕后的 2x2 矩阵
//   - Conic: 2D协方差的逆矩阵，用于快速计算高斯函数
//   - 球谐函数：用 SH 系数表示的方向相关光照函数
// ============================================================================
