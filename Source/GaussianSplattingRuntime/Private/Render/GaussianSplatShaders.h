...
public:
    ...
    BEGIN_SHADER_PARAMETER_STRUCT(FParameters, )
        ...
        SHADER_PARAMETER_RDG_BUFFER_SRV(StructuredBuffer<uint2>, SplatCellRanges)
        ...
        SHADER_PARAMETER_SRV(StructuredBuffer<float4>, SplatPositionColorBuffer)
...
public:
    ...
    BEGIN_SHADER_PARAMETER_STRUCT(FParameters, )
        ...
        SHADER_PARAMETER_SRV(StructuredBuffer<float2>, SplatCovariance1Buffer)
