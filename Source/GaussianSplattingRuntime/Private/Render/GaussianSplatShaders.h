...
public:
    ...
    BEGIN_SHADER_PARAMETER_STRUCT(FParameters, )
        ...
        SHADER_PARAMETER_RDG_BUFFER_SRV(StructuredBuffer<float4>, SplatPositionBuffer)
...
public:
    ...
    BEGIN_SHADER_PARAMETER_STRUCT(FParameters, )
        ...
        SHADER_PARAMETER_RDG_BUFFER_SRV(StructuredBuffer<float4>, SplatPositionBuffer)
        SHADER_PARAMETER_RDG_BUFFER_SRV(StructuredBuffer<float4>, SplatCov3D0Buffer)
        SHADER_PARAMETER_RDG_BUFFER_SRV(StructuredBuffer<float4>, SplatCov3D1Buffer)
        SHADER_PARAMETER_RDG_BUFFER_SRV(StructuredBuffer<float4>, SplatColorBuffer)
        SHADER_PARAMETER_RDG_BUFFER_SRV(StructuredBuffer<float4>, SplatWorldToLocalRow0Buffer)
        SHADER_PARAMETER_RDG_BUFFER_SRV(StructuredBuffer<float4>, SplatWorldToLocalRow1Buffer)
        SHADER_PARAMETER_RDG_BUFFER_SRV(StructuredBuffer<float4>, SplatWorldToLocalRow2Buffer)
        SHADER_PARAMETER_RDG_BUFFER_SRV(StructuredBuffer<float4>, SplatSHBuffer)
